<template>
  <v-container class="pa-6 grey-lighten-4" fluid>
    <div class="d-flex align-center justify-space-between mb-8">
      <div>
        <h1 class="text-h4 font-weight-black mb-1">{{ $t('dashboard.title') }}</h1>
        <p class="text-subtitle-1 text-grey-darken-1">{{ $t('dashboard.subtitle') }}</p>
      </div>
    ...
    <v-row>
        ...
        <v-row>
            ...
            <v-card elevation="2" class="rounded-xl overflow-hidden border-0 h-100">
              <v-card-text class="pa-6">
                <div class="d-flex justify-space-between align-start">
                  <div>
                    <span class="text-overline text-grey-darken-1 font-weight-bold">{{ $t('dashboard.total_projects') }}</span>
          ...
          <v-col cols="6">
            <v-card elevation="2" class="rounded-xl overflow-hidden border-0 h-100">
              <v-card-text class="pa-6">
                <div class="d-flex justify-space-between align-start">
                  <div>
                    <span class="text-overline text-grey-darken-1 font-weight-bold">{{ $t('dashboard.total_tasks') }}</span>
          ...
          <v-col cols="12">
            <v-card elevation="2" class="rounded-xl border-0 h-100 pa-2">
              <v-card-title class="text-subtitle-2 font-weight-bold">{{ $t('dashboard.status_distribution') }}</v-card-title>
              <v-card-text>
      ...
      <v-col cols="12" md="9">
        <v-card elevation="2" class="rounded-xl border-0 pa-6">
          <h3 class="text-h6 font-weight-bold mb-6">{{ $t('dashboard.activity_timeline') }}</h3>
